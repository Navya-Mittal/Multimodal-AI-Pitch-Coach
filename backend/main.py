"""
PitchPolish backend — FastAPI service.
...
app = FastAPI(title="PitchPolish API")
...
async def analyze(file: UploadFile = File(...)):
    """
    Accepts a video file (mp4/mov/webm) OR a slide PDF.
    Returns a session_id + the 5-axis scorecard.
    """
